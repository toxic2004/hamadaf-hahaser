...
-- This file documents a migration that was already applied directly to
-- the live Supabase project on 2026-07-21 but was never committed to git.
-- Reproduced verbatim from supabase_migrations.schema_migrations.statements
-- for this version. Do not re-apply; this is a record of what already ran.
